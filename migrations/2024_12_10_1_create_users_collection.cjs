      ...
      validator: {
        $jsonSchema: {
          ...
          properties: {
            ...
            followers: {
              bsonType: 'array',
              items: { bsonType: 'objectId', description: 'Must be a valid ObjectId' },
              description: 'Must be an array of follower ObjectIds',
            },
            following: {
              bsonType: 'array',
              items: { bsonType: 'objectId', description: 'Must be a valid ObjectId' },
              description: 'Must be an array of following ObjectIds',
            },
            profileImg: {
              bsonType: 'object',
              properties: {
